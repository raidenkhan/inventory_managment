...
<div className="mb-6">
    <div className="flex items-center border-2 border-gray-200 rounded">
        ...
        <input className="w-full py-2 px-4 rounded g-white" value={searchTerm} placeholder="search products .." name="" id="" onChange={e=>setSearchTerm(e.target.value)} />
    </div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg-grid-cols-3 gap-10 justify-between">
    {
        isLoading?(<div>Loading ...</div>):(
            products?.map((product)=>(
                <div key={product.productId.toString()} className="boder shadow rounded-md px-4 max-w-full w-full mx-auto">

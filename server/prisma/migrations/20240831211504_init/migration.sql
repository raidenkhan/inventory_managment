/*
  ...
  - You are about to drop the column `timesStamp` on the `Purchases` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Purchases" DROP COLUMN "timesStamp",
ADD COLUMN     "timestamp" TIMESTAMP(3) NOT NULL;
